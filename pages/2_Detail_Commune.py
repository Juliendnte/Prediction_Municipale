...
st.set_page_config(page_title="POLITIQUE | Detail Commune", page_icon="🗳️", layout="wide")
inject_theme()

st.markdown('<div class="display" style="font-size:30px;">Detail Commune</div>', unsafe_allow_html=True)
